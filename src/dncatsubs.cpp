...
void READ_BRAIN_CURVES(char *filename, CURVE motion_curve[6]) {
  ...
  */
  ...
  NEXTLINE(fp);
  count = 0;
  flag = fscanf(fp, "%f %f %f %f %f %f %f", &time, &ang_x, &ang_y, &ang_z, &t_x,
                &t_y, &t_z);

  while (flag) {
    count++;
    period = time;
    flag = fscanf(fp, "%f %f %f %f %f %f %f", &time, &ang_x, &ang_y, &ang_z,
                  &t_x, &t_y, &t_z);
  }
  num = count;
  ...
  for (i = 0; i < 6; i++) {
    ...
    Calc_UniformKnotVector(motion_curve[i].pol.n - 1, p_degree,
                           motion_curve[i].knt, motion_curve[i].uk);
  }
  fclose(fp);
  ...
  if (num < 3) {
    printf(
        "\n!!! Number of time points for curves must be greater than 3 for "
        "cubic interpolation");
    exit(1);
  }
...
*/
{
  ...
  ** READ PARAMETER FILE
  */
  if ((fp = fopen(parfile, "r")) == NULL) Abort("Cannot open parfile");

  fscanf(fp, "%i", &act_phan_each);
  NEXTLINE(fp);
  fscanf(fp, "%i", &act_phan_ave);
  NEXTLINE(fp);

  fscanf(fp, "%i", &motion_option);
  NEXTLINE(fp);

  fscanf(fp, "%f", &out_period);
  NEXTLINE(fp);
  fscanf(fp, "%i", &out_frames);
  NEXTLINE(fp);

  fscanf(fp, "%f", &motion_period);
  NEXTLINE(fp);
  fscanf(fp, "%f", &motion_start_ph_index);
  NEXTLINE(fp);
  fscanf(fp, "%i", &user_time_flag);
  NEXTLINE(fp);
  fscanf(fp, "%f", &x_trans);
  NEXTLINE(fp);
  fscanf(fp, "%f", &y_trans);
  ...
  fscanf(fp, "%f", &z_rot);
  NEXTLINE(fp);
  fscanf(fp, "%s", user_motion_file);
  NEXTLINE(fp);
  fscanf(fp, "%f", &pixel_width);
  NEXTLINE(fp);
  fscanf(fp, "%f", &slice_width);
  NEXTLINE(fp);
  fscanf(fp, "%i", &array_size);
  NEXTLINE(fp);
  fscanf(fp, "%i", &startslice);
  NEXTLINE(fp);
  fscanf(fp, "%i", &endslice);
  NEXTLINE(fp);
  fscanf(fp, "%i", &subvoxel_index);
  NEXTLINE(fp);

  fscanf(fp, "%f", &activity[10]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[70]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[2]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[50]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[75]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[15]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[5]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[80]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[6]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[90]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[1]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[85]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[7]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[27]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[114]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[9]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[88]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[52]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[60]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[41]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[19]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[159]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[32]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[56]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[110]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[74]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[145]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[61]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[130]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[64]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[140]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[164]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[26]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[62]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[165]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[119]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[99]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[196]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[139]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[118]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[125]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[18]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[132]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[251]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[38]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[98]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[63]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[154]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[97]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[37]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[175]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[54]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[112]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[69]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[4]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[108]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[53]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[39]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[16]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[14]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[11]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[12]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[203]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[102]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[133]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[255]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[232]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[233]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[8]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[3]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[20]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[13]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[17]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[30]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[45]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[73]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[105]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[57]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[59]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[83]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[243]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[21]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[28]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[24]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[36]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[101]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[25]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[72]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[254]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[29]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[35]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[34]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[23]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[33]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[128]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[43]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[76]);
  NEXTLINE(fp);
  fscanf(fp, "%f", &activity[67]);
  NEXTLINE(fp);
...
*/
{
  ...
  if ((m_fp = fopen(file, "r")) == NULL) Abort("Can not open motion file");
...
/*---------------------------------------------------------------------------------------*/
/*---------------------------------------------------------------------------------------*/
void Rotate(float x_rot, float y_rot, float z_rot, float *p, float tx, float ty,
            float tz)
/*---------------------------------------------------------------------------------------
...
/*-----------------------------------------------------------------------------------*/
/*-----------------------------------------------------------------------------------*/
void scale(float x_center, float y_center, float z_center, float xbegin,
           float ybegin, float zbegin, float *xend, float *yend, float *zend,
           float factor)
/*------------------------------------------------------------------------------------
**  This subroutine is used to scale a point (xbegin, ybegin, zbegin) by the
*amount
**  factor.  The origin for the scaling operation is the point
**  (x_center, y_center, z_center). The scaled point is returned as (xend, yend,
*zend).
**------------------------------------------------------------------------------------
*/
{
...
/*--------------------------------------------------------------------------------------------*/
float Set_scale(float xp, float yp, float zp, float *xend, float *yend,
                float *zend, float xc, float yc, float zc, float dist, float x1,
                float x2, float xacc)
/*--------------------------------------------------------------------------------------------*/
/*--------------------------------------------------------------------------------------------
...
*/
{
  ...
  f = dist - tmp_dist;
  if (fabs(f) < xacc) return x1;

  scale(xc, yc, zc, xp, yp, zp, xend, yend, zend, x2);
  tmp_dist = distance(xp, yp, zp, *xend, *yend, *zend);

  fmid = dist - tmp_dist;
  if (fabs(fmid) < xacc) return x2;
...
*/
{
  ...
  nrb_model->max_z =
      floor((max_z) / (slice_width / subvoxel_index * 10.0) + 0.5);
  nrb_model->min_z =
      floor((min_z) / (slice_width / subvoxel_index * 10.0) + 0.5);
}
/*----------------------------------------------------------------*/
...
**    m,n:      number of control points in the v and u directions of the
*surface
**-------------------------------------------------------------------------------
*/
{
...
*/
{
  ...
  for (i = 0; i <= 3; i++) nrb_model->knu.U[i] = 0.0;
  for (i = nrb_model->net.n; i <= n + 3; i++) nrb_model->knu.U[i] = 1.0;
  for (i = 4; i <= n - 1; i++)
    nrb_model->knu.U[i] = (float)(i - 3.0) / (n - 3.0);

  for (i = 0; i <= 3; i++) nrb_model->knv.U[i] = 0.0;
  for (i = nrb_model->net.m; i <= m + 3; i++) nrb_model->knv.U[i] = 1.0;
  for (i = 4; i <= m - 1; i++)
...
void CalculateCenter(SURFACE *nrb_surf, float *centerx, float *centery,
                     float *centerz) {
  int i, j;
...
void Write(int intensity, int x, int y, float *out) {
  if (x < 0) x = 0;
  if (x >= txdim) x = txdim - 1;
  if (y < 0) y = 0;
  if (y >= tydim) y = tydim - 1;
...
void Plane_eqn(FloatType *p1, FloatType *p2, FloatType *p3, FloatType *A,
               FloatType *B, FloatType *C, FloatType *D) {
  // FloatType v1[3], v2[3];
  // FloatType result[3];
...
void Plane_eqn(const point<FloatTypeI> &p1, const point<FloatTypeI> &p2,
               const point<FloatTypeI> &p3, FloatTypeO *A, FloatTypeO *B,
               FloatTypeO *C, FloatTypeO *D) {
...
int Test_patch_z(double patch[4][4][3], int z) {
  ...
  if (denom == 0.0) {
    ...
    while (denom == 0.0 && i <= 2) {
      j = 0;
      while (denom == 0.0 && j <= 2) {
        Plane_eqn(patch[i][j], patch[i][j + 1], patch[i + 1][j], &A, &B, &C,
                  &D);
        j++;
      }
      i++;
  ...
  if (denom == 0.0) {
    while (denom == 0.0 && i <= 2) {
      j = 0;
      while (denom == 0.0 && j <= 2) {
        Plane_eqn(patch[i][j], patch[i][j + 1], patch[i + 1][j + 1], &A, &B, &C,
                  &D);
        j++;
      }
      i++;
  ...
  for (i = 0; i < 4; i++)
    for (j = 0; j < 4; j++) {
      if (denom != 0)
        t_error = fabs(
            (A * patch[i][j][0] + B * patch[i][j][1] + C * patch[i][j][2] + D) /
            denom);
      else
        t_error = 0.0;
      if (t_error > max_error) max_error = t_error;
    }
...
void Subdivide_patch(double patch[4][4][3], double ul_patch[4][4][3],
                     double ur_patch[4][4][3], double dl_patch[4][4][3],
...
int Test_extents_z(double patch[4][4][3], int z) {
  ...
  for (i = 0; i < 4; i++)
    for (j = 0; j < 4; j++) {
      if (patch[i][j][2] < minz) minz = patch[i][j][2];
      if (patch[i][j][2] > maxz) maxz = patch[i][j][2];
    }
...
void Intersect_bez_z(double patch[4][4][3], float *out, int intensity, int z) {
  double ul_patch[4][4][3], ur_patch[4][4][3], dl_patch[4][4][3],
      dr_patch[4][4][3];
...
void Render_Bezier(BEZIER_MODEL *bez_model, float *out, int intensity, int z) {
  ...
  for (i = 0; i < bez_model->num_patches; i++) {
    if (z >= bez_model->patches[i].slice_minz &&
        z <= bez_model->patches[i].slice_maxz)
...
int Check_Y_Boundary(int x, int y, int threshold, float *out) {
  ...
  while (!bound1 && i < tydim) {
    index = x + i * txdim;
    if ((int)out[index] == threshold) bound1 = 1;
    i++;
  }
  ...
  while (!bound2 && i >= 0) {
    index = x + i * txdim;
    if ((int)out[index] == threshold) bound2 = 1;
    i--;
  }
...
#endif
    void
    Rotate_Y(FloatType cosRot, FloatType sinRot, FloatArrayType p) {
  // Rotate about y
...
#endif
    void
    Rotate_Z(FloatType cosRot, FloatType sinRot, FloatArrayType p)
/*---------------------------------------------------------------------------------------
...
void Fill(int intensity, float *out) {
  ...
  for (i = 0; i < XDIM * subvoxel_index; i++) edge[i] = -1;
      ...
      if (edge_counter - 2 >= 0) {
        if (edge[edge_counter - 1] != -1 && edge[edge_counter - 2] != -1) {
          if (edge[edge_counter - 1] - edge[edge_counter - 2] > 1)
            flag = Check_Y_Boundary(
                (edge[edge_counter - 2] + edge[edge_counter - 1]) / 2, y,
                intensity, out);

          if (flag) {
            G_line(edge[edge_counter - 2], tydim - y, edge[edge_counter - 1],
                   tydim - y, intensity, out);
            flag = 0;
          }
        }
      }
...
int Test_extents(float xl, float xh, float yl, float yh, float zl, float zh,
                 float line_origin[3], float line_vector[3]) {
  int flag = 0;
  int i, j;
...
int Test_extents2(double patch[4][4][3], float line_origin[3],
                  float line_vector[3]) {
  int flag = 0;
  float xl, yl, zl;
  float xh, yh, zh;
  ...
  for (i = 0; i < 4; i++)
    for (j = 0; j < 4; j++) {
      if (patch[i][j][2] < zl) zl = patch[i][j][2];
      if (patch[i][j][2] > zh) zh = patch[i][j][2];

      if (patch[i][j][1] < yl) yl = patch[i][j][1];
      if (patch[i][j][1] > yh) yh = patch[i][j][1];

      if (patch[i][j][0] < xl) xl = patch[i][j][0];
      if (patch[i][j][0] > xh) xh = patch[i][j][0];
    }
...
void Check_difference(double xint, double *min_error, XP_ARRAY *int_points) {
  ...
  *min_error = 1.0;
  ...
  for (i = 0; i < int_points->length; i++) {
    ...
    if (tmp_error < *min_error) *min_error = tmp_error;
  }
}

void Intersect_bez(double patch[4][4][3], int organ_id, XP_ARRAY *int_points,
                   double tol, float line_origin[3], float line_vector[3])
/* ------------------------------------------------------------------------------------
   */
/* This routine iteratively breaks down surface patches until it finds one that
   is flat */
/* and is intersected by the projection ray.  Once it finds a flat patch, it
   calculates */
   ...
   */
{
  ...
  if (Test_patch(patch, tol)) {
    ...
    numerator =
        A * line_origin[0] + B * line_origin[1] + C * line_origin[2] + D;
    ...
    if (Test_extents2(ul_patch, line_origin, line_vector))
      Intersect_bez(ul_patch, organ_id, int_points, tol, line_origin,
                    line_vector);
    if (Test_extents2(ur_patch, line_origin, line_vector))
      Intersect_bez(ur_patch, organ_id, int_points, tol, line_origin,
                    line_vector);
    if (Test_extents2(dl_patch, line_origin, line_vector))
      Intersect_bez(dl_patch, organ_id, int_points, tol, line_origin,
                    line_vector);
    if (Test_extents2(dr_patch, line_origin, line_vector))
      Intersect_bez(dr_patch, organ_id, int_points, tol, line_origin,
                    line_vector);
  }
}

void Find_Intersections(BEZIER_MODEL *bez_model, int organ_id,
                        float line_origin[3], float line_vector[3],
                        XP_ARRAY *int_points, double tol) {
  int i;
  ...
  for (i = 0; i < bez_model->num_patches; i++) {
    if (Test_extents(bez_model->patches[i].minx, bez_model->patches[i].maxx,
      ...
      Intersect_bez(bez_model->patches[i].cntrl_points, organ_id, int_points,
                    tol, line_origin, line_vector);
  }
}
...
void GetVolumes(float *out_pixel) {
  ...
  for (unsigned index = 0; index <= END_MODELS; index++) vol[index] = 0.0;
  ...
  printf(
      "\nVolume of superior frontal gyrus right                                "
      "    %f",
      vol[10]);
  printf(
      "\nVolume of superior frontal gyrus left                                 "
      "    %f",
      vol[70]);
  printf(
      "\nVolume of middle frontal gyrus right                                  "
      "    %f",
      vol[2]);
  printf(
      "\nVolume of middle frontal gyrus left                                   "
      "    %f",
      vol[50]);
  printf(
      "\nVolume of inferior frontal gyrus right                                "
      "    %f",
      vol[75]);
  printf(
      "\nVolume of inferior frontal gyrus left                                 "
      "    %f",
      vol[15]);
  printf(
      "\nVolume of precentral gyrus right                                      "
      "    %f",
      vol[5]);
  printf(
      "\nVolume of precentral gyrus left                                       "
      "    %f",
      vol[80]);
  printf(
      "\nVolume of lateral front-orbital gyrus right                           "
      "    %f",
      vol[6]);
  printf(
      "\nVolume of lateral front-orbital gyrus left                            "
      "    %f",
      vol[90]);
  printf(
      "\nVolume of medial front-orbital gyrus right                            "
      "    %f",
      vol[1]);
  printf(
      "\nVolume of medial front-orbital gyrus left                             "
      "    %f",
      vol[85]);
  printf(
      "\nVolume of cingulate region right                                      "
      "    %f",
      vol[7]);
  printf(
      "\nVolume of cingulate region left                                       "
      "    %f",
      vol[27]);
  printf(
      "\nVolume of medial frontal gyrus right                                  "
      "    %f",
      vol[114]);
  printf(
      "\nVolume of medial frontal gyrus left                                   "
      "    %f",
      vol[9]);
  printf(
      "\nVolume of superior parietal lobule right                              "
      "    %f",
      vol[88]);
  printf(
      "\nVolume of superior parietal lobule left                               "
      "    %f",
      vol[52]);
  printf(
      "\nVolume of supramarginal gyrus right                                   "
      "    %f",
      vol[60]);
  printf(
      "\nVolume of supramarginal gyrus left                                    "
      "    %f",
      vol[41]);
  printf(
      "\nVolume of angular gyrus right                                         "
      "    %f",
      vol[19]);
  printf(
      "\nVolume of angular gyrus left                                          "
      "    %f",
      vol[159]);
  printf(
      "\nVolume of precuneus right                                             "
      "    %f",
      vol[32]);
  printf(
      "\nVolume of precuneus left                                              "
      "    %f",
      vol[56]);
  printf(
      "\nVolume of postcentral gyrus right                                     "
      "    %f",
      vol[110]);
  printf(
      "\nVolume of postcentral gyrus left                                      "
      "    %f",
      vol[74]);
  printf(
      "\nVolume of superior temporal gyrus right                               "
      "    %f",
      vol[145]);
  printf(
      "\nVolume of superior temporal gyrus left                                "
      "    %f",
      vol[61]);
  printf(
      "\nVolume of middle temporal gyrus right                                 "
      "    %f",
      vol[130]);
  printf(
      "\nVolume of middle temporal gyrus left                                  "
      "    %f",
      vol[64]);
  printf(
      "\nVolume of inferior temporal gyrus right                               "
      "    %f",
      vol[140]);
  printf(
      "\nVolume of inferior temporal gyrus left                                "
      "    %f",
      vol[164]);
  printf(
      "\nVolume of uncus right                                                 "
      "    %f",
      vol[26]);
  printf(
      "\nVolume of uncus left                                                  "
      "    %f",
      vol[62]);
  printf(
      "\nVolume of medial occipitotemporal gyrus right                         "
      "    %f",
      vol[165]);
  printf(
      "\nVolume of medial occipitotemporal gyrus left                          "
      "    %f",
      vol[119]);
  printf(
      "\nVolume of lateral occipitotemporal gyrus right                        "
      "    %f",
      vol[99]);
  printf(
      "\nVolume of lateral occipitotemporal gyrus left                         "
      "    %f",
      vol[196]);
  printf(
  ...
  printf(
      ...
      vol[118]);
  printf(
      "\nVolume of parahippocampal gyrus right                                 "
      "    %f",
      vol[125]);
  printf(
      "\nVolume of parahippocampal gyrus left                                  "
      "    %f",
      vol[18]);
  printf(
      "\nVolume of occipital pole right                                        "
      "    %f",
      vol[132]);
  printf(
      "\nVolume of occipital pole left                                         "
      "    %f",
      vol[251]);
  printf(
      "\nVolume of superior occipital gyrus right                              "
      "    %f",
      vol[38]);
  printf(
      "\nVolume of superior occipital gyrus left                               "
      "    %f",
      vol[98]);
  printf(
      "\nVolume of middle occipital gyrus right                                "
      "    %f",
      vol[63]);
  printf(
      "\nVolume of middle occipital gyrus left                                 "
      "    %f",
      vol[154]);
  printf(
      "\nVolume of inferior occipital gyrus right                              "
      "    %f",
      vol[97]);
  printf(
      "\nVolume of inferior occipital gyrus left                               "
      "    %f",
      vol[37]);
  printf(
      "\nVolume of cuneus right                                                "
      "    %f",
      vol[175]);
  printf(
      "\nVolume of cuneus left                                                 "
      "    %f",
      vol[54]);
  printf(
      "\nVolume of lingual gyrus right                                         "
      "    %f",
      vol[112]);
  printf(
      "\nVolume of lingual gyrus left                                          "
      "    %f",
      vol[69]);
  printf(
      "\nVolume of insula right                                                "
      "    %f",
      vol[4]);
  printf(
      "\nVolume of insula left                                                 "
      "    %f",
      vol[108]);
  printf(
      "\nVolume of caudate nucleus right                                       "
      "    %f",
      vol[53]);
  printf(
      "\nVolume of caudate nucleus left                                        "
      "    %f",
      vol[39]);
  printf(
  ...
  printf(
      ...
      vol[14]);
  printf(
      "\nVolume of globus palladus right                                       "
      "    %f",
      vol[11]);
  printf(
      "\nVolume of globus palladus left                                        "
      "    %f",
      vol[12]);
  printf(
  ...
  printf(
      ...
      vol[133]);
  printf(
      "\nVolume of subarachnoid cerebro-spinal fluid                           "
      "    %f",
      vol[255]);
  printf(
      "\nVolume of third ventricle                                             "
      "    %f",
      vol[232]);
  printf(
      "\nVolume of fourth ventricle                                            "
      "    %f",
      vol[233]);
  printf(
  ...
  printf(
      ...
      vol[3]);
  printf(
      "\nVolume of brain stem                                                  "
      "    %f",
      vol[20]);
  printf(
      "\nVolume of frontal lobe WM right                                       "
      "    %f",
      vol[17]);
  printf(
      "\nVolume of frontal lobe WM left                                        "
      "    %f",
      vol[30]);
  printf(
      "\nVolume of occipital lobe WM right                                     "
      "    %f",
      vol[45]);
  printf(
      "\nVolume of occipital lobe WM left                                      "
      "    %f",
      vol[73]);
  printf(
      "\nVolume of parietal lobe WM right                                      "
      "    %f",
      vol[105]);
  printf(
      "\nVolume of parietal lobe WM left                                       "
      "    %f",
      vol[57]);
  printf(
      "\nVolume of temporal lobe WM right                                      "
      "    %f",
      vol[59]);
  printf(
      "\nVolume of temporal lobe WM left                                       "
      "    %f",
      vol[83]);
  printf(
      "\nVolume of scalp                                                       "
  ...
  printf(
      ...
      vol[28]);
  printf(
      "\nVolume of hippocampal formation right                                 "
      "    %f",
      vol[36]);
  printf(
      "\nVolume of hippocampal formation left                                  "
      "    %f",
      vol[101]);
  printf(
      "\nVolume of nucleus accumbens right                                     "
      "    %f",
      vol[25]);
  printf(
      "\nVolume of nucleus accumbens left                                      "
      "    %f",
      vol[72]);
  printf(
      "\nVolume of fornix right                                                "
      "    %f",
      vol[254]);
  printf(
      "\nVolume of fornix left                                                 "
      "    %f",
      vol[29]);
  printf(
      "\nVolume of posterior limb of internal capsule inc. cerebral peduncle "
      "right %f",
      vol[35]);
  printf(
      "\nVolume of posterior limb of internal capsule inc. cerebral peduncle "
      ...
      vol[34]);
  printf(
      "\nVolume of subthalamic nucleus right                                   "
      "    %f",
      vol[23]);
  printf(
      "\nVolume of subthalamic nucleus left                                    "
      "    %f",
      vol[33]);
  printf(
      "\nVolume of anterior limb of internal capsule right                     "
      "    %f",
      vol[128]);
  printf(
      "\nVolume of anterior limb of internal capsule left                      "
      "    %f",
      vol[43]);
  printf(
      "\nVolume of cerebellum right                                            "
      "    %f",
      vol[76]);
  printf(
      "\nVolume of cerebellum left                                             "
      "    %f",
      vol[67]);
}
...
void Calc_extents_tri(TRI_MODEL *tmodel) {
  ...
  tmodel->max_z =
      floor((tmodel->max_z) / (slice_width / subvoxel_index * 10.0) + 0.5);
  tmodel->min_z =
      floor((tmodel->min_z) / (slice_width / subvoxel_index * 10.0) + 0.5);
}

void MoveTriangleModel(TRI_MODEL *tmodel, float x_trans, float y_trans,
  ...
  R[0][0] = cos(Y) * cos(Z);
  R[0][1] = sin(X) * sin(Y) * cos(Z) - cos(X) * sin(Z);
  R[0][2] = cos(X) * sin(Y) * cos(Z) + sin(X) * sin(Z);
  R[1][0] = cos(Y) * sin(Z);
  R[1][1] = sin(X) * sin(Y) * sin(Z) + cos(X) * cos(Z);
  R[1][2] = cos(X) * sin(Y) * sin(Z) - sin(X) * cos(Z);
  R[2][0] = -sin(Y);
  R[2][1] = cos(Y) * sin(X);
  R[2][2] = cos(Y) * cos(X);
...
void Output_Triangle_Model(char *filename, TRI_MODEL *tmodel) {
  ...
  for (i = 0; i < tmodel->num_tris; i++) {
    fprintf(fp, "\n");
    for (j = 0; j < 3; j++)
      fprintf(fp, "%f %f %f ", tmodel->tris[i].vertex[j].x,
              tmodel->tris[i].vertex[j].y, tmodel->tris[i].vertex[j].z);
  }
...
void Read_Triangle_ModelVTK(char *filename, TRI_MODEL *tmodel) {
  ...
  for (i = 0; i < num_strips; i++) {
    ...
    for (j = 0; j < num; j++) fscanf(fp, "%i", &fields[j]);
...
int Test_extents_tri_z(TRIANGLE tri, int z) {
  ...
  for (j = 1; j < 3; j++) {
    if (tri.vertex[j].z < minz) minz = tri.vertex[j].z;
    if (tri.vertex[j].z > maxz) maxz = tri.vertex[j].z;
  }
...
/* Function tests the extents of a Triangle */
{
  ...
  for (i = 1; i < 3; i++) {
    if (T.vertex[i].z < minz) minz = T.vertex[i].z;
    if (T.vertex[i].z > maxz) maxz = T.vertex[i].z;

    if (T.vertex[i].y < miny) miny = T.vertex[i].y;
    if (T.vertex[i].y > maxy) maxy = T.vertex[i].y;

    if (T.vertex[i].x < minx) minx = T.vertex[i].x;
    if (T.vertex[i].x > maxx) maxx = T.vertex[i].x;
  }
...
/* Checks to see if point is inside the triangle */
{
  ...
  if (xint >= -eps) {
    ...
    if (fabs(angle - 2 * PI) < eps) return 1;
  }
  return 0;
}
...
void Intersect_tri(TRIANGLE T, int organ_id, XP_ARRAY *int_points) {
  ...
  if (A != 0.0)  // abs(A) > std::numeric_limits<double>::min()
    xint = -D / A;
  // else xint = std::numeric_limits<double>::max() * (signbit(D) == signbit(A)
  // ? -1 : 1);

  if (xint <= 0)
    xint = std::accumulate(T.vertex, T.vertex + 3, 0.0f,
                           [](float sum, POINT &p) { return sum + p.x; }) /
           3.0;
  /*{
    xint = 0;
    for(i = 0; i < 3; i++)
...
void Find_Intersections_tri(TRI_MODEL *tri_model, int organ_id,
                            float line_origin[3], float line_vector[3],
                            XP_ARRAY *int_points) {
  typedef float FLOAT;

  const FLOAT magnitude =
      sqrt(line_vector[0] * line_vector[0] + line_vector[1] * line_vector[1] +
  ...
  const double thetaRad =
      Calc_Angle(line_vector[0], line_vector[1]) * PI / 180.0;

  // speed optimisation
  const FLOAT cosPhi = cos(phiRad), sinPhi = sin(phiRad);
  const FLOAT cosTheta = cos(thetaRad), sinTheta = sin(thetaRad);

  for (TRIANGLE *tri = tri_model->tris,
                *triEnd = tri_model->tris + tri_model->num_tris;
       tri != triEnd; tri++) {
    TRIANGLE T;
    for (int j = 0; j < 3; j++) {
      // double p[3];
    ...
    if (Test_extents_tri(T)) Intersect_tri(T, organ_id, int_points);
  }
}

int Check_Y_Boundary2(TRI_MODEL slice_tmodel, int x, int y, int z,
                      int intensity) {
  int j, i, flag;
  ...
  int_points.length = 0;
  Find_Intersections_tri(&slice_tmodel, intensity, line_origin, line_vector,
                         &int_points);
...
void Fill_tri(TRI_MODEL slice_tmodel, int intensity, float *out, int z) {
  ...
  for (int y = 0; y < tydim; ++y) {
    ...
    for (int x = 0; x < txdim; ++x) {
      if (int(yslice[x]) == intensity) edge[edge_counter++] = x;
    }
    for (int e = edge[--edge_counter], ePrev; edge_counter > 0;
         --edge_counter) {
      ePrev = edge[edge_counter - 1];
      if (e != -1 && ePrev != -1 && e - ePrev > 1 &&
